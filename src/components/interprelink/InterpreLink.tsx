...
export default function InterpreHub() {
  ...
  const discussions = [
    ...
    },
    {
      ...
      title: "",
      content:
        "Adding to Ben's point - requesting clarification is often the *best* practice in medical settings",
      likes: 0,
      replies: 0,
      isReply: true,
      category: "Best Practices",
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-8">
                <h1 className="text-4xl font-bold mb-4">
                  Medical Interpreters' Hub
                </h1>
                <p className="text-xl text-muted-foreground mb-6">
                  Connect, share challenges, and discuss best practices in
              ...
              <div className="space-y-6">
                {discussions.map((discussion) => (
                  <Card
                    key={discussion.id}
                    className={`${discussion.isReply ? "ml-12" : ""}`}
                  >
                    <CardHeader>
